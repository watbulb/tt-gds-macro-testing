...
# SPDX-FileCopyrightText: 2024 TinyTapeout & Contributors
...
# tt-gds-macro-testing BEGIN
# Added for direct execution
if __name__ == '__main__':
    # gds, lef, def, toplevel, uses_3v3
    pin_check(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], False)
# tt-gds-macro-testing END